...
- 切換 L1 關係時保留目前 L2 題目類型
- 指定題號下拉選單
- 0 到 100 分的猜測準確度評分
- 評語紀錄
- 評語紀錄可收合，適合長局數遊玩
- 對象名稱可鎖定，匯入多對象紀錄時會依對象分組
- 評語紀錄會優先顯示目前遊玩對象
- 已完成題數依目前遊玩對象追蹤
- 風格切換樣板
  - 溫馨桌遊
...
`AGENTS.md` 記錄跨工作機或新 Codex session 接手時需要知道的協作規則、資料模型、branch 狀態與注意事項。  
若產品規則或資料結構有變更，請同步更新 `AGENTS.md`、`README.md` 與 `HISTORY.md`。
